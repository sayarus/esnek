...
_Esnek_ provides a quick Ruby interface for JSON  APIs, such as ElasticSearch, Google APIs, Facebook Graph API.. 
...
Esnek is under heavy development in april 2011, so gem update frequently.
